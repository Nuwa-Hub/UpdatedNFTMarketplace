    ...
    <div className="w-full h-[80px] z-10 bg-gray-50 sticky top-0 ">
      <div className="px-2 flex justify-between items-center w-full h-full">
        <div className="flex items-center">
          ...
          <h2 className="text-xl font-bold mr-4 sm:text-2xl">Kryptonaut</h2>
        </div>
        <form className="w-[50%]">
          {/* <label
      ...
      <ul className={!nav ? "hidden" : "absolute bg-zinc-200 w-full px-8"}>
        ...
        <li className="border-b-2 border-zinc-300 w-full  p-2">
          <Link href={`/collection/create`} smooth={true} duration={500}>
            <a>Create Collection</a>
          </Link>
        </li>
        <li className="border-b-2 border-zinc-300 w-full  p-2">
        ...
        <li className="border-b-2 border-zinc-300 w-full  p-2">
          <Link href={`/collection/user`} smooth={true} duration={500}>
            <a>My Collections</a>
          </Link>
        </li>
        <li className="border-b-2 border-zinc-300 w-full  p-2">
