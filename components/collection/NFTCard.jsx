        ...
        <div class="p-2 w-full flex">
          ...
          <div className="w-full flex justify-around">
            {!lowToHigh && (
              ...
              >
                <span class="w-full flex align-middle">Price low to high</span>
              </button>
            )}
            {lowToHigh && (
              <button
            ...
            {!highToLow && (
              <button
                ...
                class="p-1 px-4 m-0.5 hover:text-blue-800 hover:border-blue-500 text-sm font-bold border-2 text-gray-600 border-gray-300 bg-white rounded-lg"
              >
                <span class="w-full flex align-middle">Price high to low</span>
              </button>
            )}
            {highToLow && (
              <button
            ...
            {!mostFavorite && (
              <button
                ...
                class="p-1 px-4 m-0.5 hover:text-blue-800 hover:border-blue-500 text-sm font-bold border-2 text-gray-600 border-gray-300 bg-white rounded-lg"
              >
                <span class="w-full flex align-middle">Most Favourite</span>
              </button>
            )}
            {mostFavorite && (
              <button
